 ...
 *
 * The default attributes and tags are based on {@see wp_kses_allowed_html}
 * with the blank (default) "context". These are the tags in {@see $allowedtags}.
 * To get all allowed post tags, pass `'post'` as the `$context` parameter,
 * or pass the tags you need in the `$allowedtags` array. If a specified tag
 * is not in the list, no attributes will be allowed.
 *
